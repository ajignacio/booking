Booking::Application.routes.draw do
  ...
  match "lesson_schedule" => "schedules#lesson_schedule"
  match "build_schedule" => "schedules#build_schedule"

  match "subscriptions" => 'subscriptions#index'
  match "subscription/:id" => 'subscriptions#build_subscribe', as: :subscribe
  match "cancel_subscription" => 'subscriptions#cancel_subscription'
